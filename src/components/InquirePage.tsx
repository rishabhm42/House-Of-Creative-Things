          ...
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-10">
            <div className="max-w-3xl">
              ...
              <h1 className="font-serif text-5xl sm:text-6xl md:text-7xl text-[#FDF9F0] font-normal leading-[1.05]">
                Commission <br />
                <span className="italic font-serif gold-gradient-text">A Creative Project</span>
              </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 text-xs font-mono text-[#FDF9F0]/80">
              <div className="p-4 border-2 border-[#F8F1E7]/40 bg-[#1E0407]/90 rounded-xs shadow-lg">
                <span className="text-[9px] uppercase tracking-[0.2em] text-[#F8F1E7] block font-bold">Direct Wire:</span>
                <span className="text-[#FCF9F5] font-medium">commissions@hoct.studio</span>
              </div>
              <div className="p-4 border-2 border-[#F8F1E7]/40 bg-[#1E0407]/90 rounded-xs shadow-lg">
                <span className="text-[9px] uppercase tracking-[0.2em] text-[#F8F1E7] block font-bold">Studio Telephone:</span>
                <span className="text-[#FCF9F5] font-medium">+91 (11) 4890-4628</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 px-6 md:px-12 border-t border-[#F8F1E7]/25 bg-[#230508]/80 relative">
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center gap-3 mb-4">
            <HelpCircle className="w-4 h-4 text-[#F8F1E7]" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {faqs.map((faq, i) => (
              <div key={i} className="border-t-2 border-[#F8F1E7]/40 pt-6 space-y-2 bg-[#1E0407]/50 p-5 rounded-xs">
