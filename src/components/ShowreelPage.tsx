...
export const ShowreelPage: React.FC<ShowreelPageProps> = ({
  ...
  return (
    <div className="pt-24 md:pt-32">
          ...
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-10">
            <div className="max-w-3xl">
              ...
              <p className="text-sm md:text-base text-[#FDF9F0]/85 font-light mt-6 max-w-2xl leading-relaxed">
                Experience our studio showreel in both widescreen cinema scope and vertical 9:16 mobile formats. Each cut explores rhythmic pacing, frame composition, and sound synchrony.
              </p>
            </div>
      ...
      <section className="py-24 px-6 md:px-12 border-t border-[#F8F1E7]/25 bg-[#230508]/85 relative">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-3 mb-4">
            <Camera className="w-4 h-4 text-[#F8F1E7]" />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {cinemaSpecs.map((spec, i) => (
              <div key={i} className="p-6 border-2 border-[#F8F1E7]/30 bg-[#1E0407]/80 rounded-xs space-y-2 shadow-lg">
                <span className="text-[10px] uppercase tracking-[0.25em] font-mono text-[#F8F1E7] block font-bold">
                  {spec.label}
                </span>
