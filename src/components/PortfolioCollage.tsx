...
export const PortfolioCollage: React.FC<PortfolioCollageProps> = ({ onSelectProject }) => {
  ...
  return (
    <section id="portfolio" className="py-24 md:py-36 bg-[#2A060B] text-[#FDF9F0] relative selection:bg-[#D4AF37] selection:text-[#2A060B] overflow-hidden">
      {/* Editorial Watermark in Background */}
      <div className="absolute top-12 right-0 select-none pointer-events-none opacity-5 font-serif text-[18vw] leading-none whitespace-nowrap text-[#D4AF37] font-bold tracking-tighter">
        FOLIO
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8 pb-12 border-b border-[#D4AF37]/25">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
            ...
            <div className="flex flex-wrap items-center gap-1.5 bg-[#1E0407]/80 p-1.5 rounded-full border border-[#D4AF37]/30">
              <button
                onClick={() => setActiveFilter('all')}
                className={`px-4 py-2 rounded-full text-[11px] uppercase tracking-[0.2em] transition-all duration-300 cursor-pointer ${
                  activeFilter === 'all'
                    ? 'bg-[#D4AF37] text-[#2A060B] font-bold shadow-xs'
                    : 'text-[#D4AF37]/80 hover:text-white'
                }`}
              >
        ...
        {viewMode === 'magazine' && (
          <div className="mt-16 space-y-28 md:space-y-40">
            ...
            {filteredProjects[0] && (
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center border-b border-[#D4AF37]/25 pb-24 md:pb-32">
                ...
                <div className="lg:col-span-7 relative">
                  ...
                  <motion.div
                    ...
                    className="group cursor-pointer relative overflow-hidden border-2 border-[#D4AF37]/40 bg-black/40 shadow-2xl rounded-xs"
                  >
                    <div className="relative aspect-[3/4] overflow-hidden">
                      ...
                      <div className="absolute top-4 left-4 bg-[#2A060B]/90 backdrop-blur-xs px-3.5 py-1 text-[10px] uppercase tracking-[0.25em] text-[#D4AF37] border border-[#D4AF37]/40 font-semibold font-mono">
                        {filteredProjects[0].category === 'video' ? '35mm Film Scan // 4K' : 'Visual Identity'}
                      </div>

                      {filteredProjects[0].videoUrl && (
                        <div className="absolute bottom-5 right-5 w-12 h-12 rounded-full bg-gradient-to-r from-[#D4AF37] via-[#F4E0A5] to-[#AA820A] text-[#2A060B] flex items-center justify-center shadow-xl group-hover:scale-110 transition-transform">
                  ...
                  {filteredProjects[0].editorialImages[1] && (
                    <motion.div
                      ...
                      onClick={() => onSelectProject(filteredProjects[0])}
                      className="absolute -bottom-8 -right-4 sm:-right-8 w-44 sm:w-56 aspect-square overflow-hidden shadow-2xl border-2 border-[#D4AF37] bg-[#1E0407] p-1.5 group cursor-pointer hidden sm:block"
                    >
                      <div className="relative w-full h-full overflow-hidden">
                        ...
                        />
                        <div className="absolute bottom-2 left-2 text-[8px] uppercase tracking-[0.2em] bg-black/85 px-2 py-0.5 text-[#D4AF37] font-mono">
                ...
                <div className="lg:col-span-5 flex flex-col justify-between space-y-6">
                  <div>
                    <div className="flex items-center justify-between border-b border-[#D4AF37]/25 pb-3 mb-4">
                      <span className="text-[11px] uppercase tracking-[0.3em] text-[#D4AF37] font-mono font-bold">
                        Plate No. 01 • {filteredProjects[0].year}
                      </span>
                      <span className="text-[10px] uppercase tracking-[0.25em] bg-[#D4AF37]/15 text-[#D4AF37] px-3 py-1 rounded-full border border-[#D4AF37]/35 font-medium">
                    ...
                    <p className="mt-2 text-xs uppercase tracking-[0.25em] text-[#D4AF37] font-medium font-mono">
                      Client: {filteredProjects[0].client}
                    </p>

                    <blockquote className="mt-6 border-l-2 border-[#D4AF37] pl-4 font-serif italic text-lg sm:text-xl text-[#FFF0CA] leading-snug">
                    ...
                    <div className="mt-6 pt-5 border-t border-[#D4AF37]/20">
                      <span className="text-[10px] uppercase tracking-[0.25em] text-[#D4AF37] block mb-2 font-mono font-bold">
                    ...
                    <div className="mt-6 flex flex-wrap gap-2">
                      {filteredProjects[0].deliverables.map((item, dIdx) => (
                        <span
                          key={dIdx}
                          className="px-3 py-1 text-[10px] uppercase tracking-wider text-[#D4AF37] border border-[#D4AF37]/40 bg-[#1E0407] font-mono"
                        >
                          {item}
                        </span>
                      ))}
                  ...
                  <button
                    onClick={() => onSelectProject(filteredProjects[0])}
                    className="inline-flex items-center gap-3 px-7 py-3.5 rounded-full bg-gradient-to-r from-[#D4AF37] via-[#F4E0A5] to-[#AA820A] text-[#2A060B] text-xs uppercase tracking-[0.2em] font-bold hover:shadow-xl hover:shadow-[#D4AF37]/30 transition-all duration-300 w-fit cursor-pointer group shadow-lg"
                  >
                ...
                <div className="lg:col-span-5 order-2 lg:order-1 flex flex-col justify-between space-y-6">
                  <div>
                    ...
                    {filteredProjects[1].editorialImages[2] && (
                      <div className="mt-6 p-3.5 border-2 border-[#D4AF37]/30 bg-[#1E0407]/80 flex items-center gap-4 rounded-xs shadow-md">
                        <img
                          src={filteredProjects[1].editorialImages[2]}
                          alt="Macro packaging"
                          className="w-16 h-16 object-cover filter contrast-115 border border-[#D4AF37]/40"
                        />
                        <div className="text-xs text-[#FDF9F0]/80 leading-tight">
                          <span className="font-mono text-[10px] uppercase tracking-wider text-[#D4AF37] block mb-1 font-bold">
                ...
                <div className="lg:col-span-7 order-1 lg:order-2">
                  ...
                  >
                    <div className="relative aspect-[16/10] overflow-hidden">
                      ...
                      <div className="absolute bottom-4 right-4 bg-black/80 backdrop-blur-xs px-3 py-1 text-[9px] uppercase tracking-[0.2em] text-[#D4AF37] font-mono">
                        Plate II // 02
                      </div>
                    </div>
                  </motion.div>
            ...
            {filteredProjects[4] && (
              <motion.div
                ...
                className="relative overflow-hidden border-2 border-[#D4AF37]/50 bg-black/50 shadow-2xl group rounded-xs"
              >
                  ...
                  <div className="absolute inset-0 p-6 sm:p-10 md:p-14 flex flex-col justify-between text-[#FDF9F0]">
                    <div className="flex justify-between items-start">
                      <div className="flex items-center gap-3">
                        <span className="px-3.5 py-1 bg-gradient-to-r from-[#D4AF37] to-[#AA820A] text-[#2A060B] text-[10px] uppercase tracking-[0.3em] font-bold">
                          Cinema Master 2.39:1
                        </span>
                        <span className="text-xs font-mono tracking-widest text-[#D4AF37] hidden sm:inline">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-end">
                      <div className="lg:col-span-8">
                        <span className="text-xs uppercase tracking-[0.3em] text-[#D4AF37] block mb-1 font-mono">
                        ...
                        <div className="mt-4 flex flex-wrap gap-2">
                          {filteredProjects[4].deliverables.map((deliv, idx) => (
                            <span key={idx} className="text-[10px] uppercase tracking-wider px-2.5 py-0.5 bg-[#2A060B]/70 border border-[#D4AF37]/40 text-[#D4AF37] font-mono">
                              {deliv}
                            </span>
                          ))}
                        </div>
                      ...
                      <div className="lg:col-span-4 flex flex-col sm:flex-row lg:flex-col items-start lg:items-end gap-3">
                        <button
                          ...
                          className="px-7 py-3.5 rounded-full bg-gradient-to-r from-[#D4AF37] via-[#F4E0A5] to-[#AA820A] text-[#2A060B] text-xs uppercase tracking-[0.2em] font-bold hover:shadow-xl hover:shadow-[#D4AF37]/30 transition-all shadow-xl flex items-center gap-2 cursor-pointer"
                        >
                          <Play className="w-3.5 h-3.5 fill-current" />
                          <span>Watch Feature Reel</span>
                        </button>
                        <span className="text-[10px] uppercase tracking-[0.2em] text-[#D4AF37]/80 font-mono">
            ...
            <div className="pt-6">
              <div className="flex items-center gap-3 mb-10 pb-4 border-b border-[#D4AF37]/25">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-10">
                {filteredProjects.slice(2, 5).map((project, idx) => (
                  <motion.div
                    ...
                    className={`group cursor-pointer relative flex flex-col justify-between border-2 border-[#D4AF37]/30 bg-[#1E0407]/70 rounded-xs shadow-xl ${
                      idx === 1 ? 'lg:-translate-y-8' : idx === 2 ? 'lg:translate-y-6' : ''
                    }`}
                  >
                    <div>
                      {/* Asymmetrical Image Container */}
                      <div className="relative aspect-[4/5] overflow-hidden border-b-2 border-[#D4AF37]/30">
                        <img
                        ...
                        <div className="absolute top-3 left-3 bg-[#2A060B]/90 px-3 py-1 text-[9px] uppercase tracking-[0.25em] text-[#D4AF37] border border-[#D4AF37]/40 font-semibold font-mono">
                          {project.category === 'video' ? 'Video' : 'Design'}
                        </div>

                        {/* Small inset thumbnail */}
                        {project.editorialImages[1] && (
                          <div className="absolute bottom-3 right-3 w-16 h-16 border-2 border-[#D4AF37] overflow-hidden shadow-lg bg-[#2A060B]">
                            <img
                      ...
                      <div className="p-6 space-y-4">
                        ...
                        <h4 className="font-serif text-2xl text-[#FDF9F0] group-hover:text-[#FFF0CA] transition-colors">
                          {project.title}
                        </h4>

                        <p className="text-xs uppercase tracking-[0.2em] text-[#D4AF37]/80 font-mono">
                          {project.client}
                        </p>
                        ...
                        <div className="pt-2 flex flex-wrap gap-1.5">
                          {project.deliverables.slice(0, 2).map((item, dIdx) => (
                            <span key={dIdx} className="text-[9px] uppercase tracking-wider text-[#D4AF37] px-2.5 py-0.5 bg-[#2A060B] border border-[#D4AF37]/35 font-mono">
                              {item}
                            </span>
                          ))}
                        </div>
                    ...
                    <div className="p-6 pt-0 flex items-center justify-between border-t border-[#D4AF37]/20 mt-4">
                      <span className="text-[10px] uppercase tracking-[0.25em] text-[#D4AF37] font-bold group-hover:text-white font-mono">
                        Open Project Folio
                      </span>
                      <div className="w-8 h-8 rounded-full border border-[#D4AF37] flex items-center justify-center group-hover:bg-[#D4AF37] group-hover:text-[#2A060B] transition-all">
        ...
        {viewMode === 'index' && (
          <div className="mt-16 grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-7 divide-y divide-[#D4AF37]/20 border-y border-[#D4AF37]/25">
                ...
                return (
                  <div
                    ...
                    className={`py-6 px-4 transition-all duration-300 cursor-pointer flex flex-col sm:flex-row sm:items-center justify-between gap-4 ${
                      isSelected
                        ? 'bg-[#D4AF37]/15 pl-6 border-l-2 border-[#D4AF37]'
                        : 'hover:bg-[#D4AF37]/5'
                    }`}
                  >
                    <div className="flex items-baseline gap-4">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-3 mt-1 text-xs text-[#FDF9F0]/80 font-light">
                          ...
                          <span>•</span>
                          <span className="italic text-[#D4AF37]">{project.subcategory}</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div className={`w-8 h-8 rounded-full border border-[#D4AF37] flex items-center justify-center transition-all ${
                        isSelected ? 'bg-[#D4AF37] text-[#2A060B]' : 'text-[#D4AF37]'
                      }`}>
                        <ArrowUpRight className="w-3.5 h-3.5" />
                      </div>
                    </div>
            ...
            <div className="lg:col-span-5 sticky top-32 border-2 border-[#D4AF37]/50 bg-[#1E0407]/90 p-6 shadow-2xl rounded-xs">
              <div className="relative">
                {/* Large Preview Image */}
                <div className="relative aspect-[16/10] overflow-hidden border border-[#D4AF37]/40">
                  <img
                    src={hoveredIndexProject.coverImage}
                    alt={hoveredIndexProject.title}
                    className="w-full h-full object-cover filter contrast-115"
                  />
                  <div className="absolute top-2 left-2 bg-[#2A060B] border border-[#D4AF37]/40 px-2.5 py-0.5 text-[9px] uppercase tracking-[0.2em] font-bold text-[#D4AF37] font-mono">
                ...
                {hoveredIndexProject.editorialImages[1] && (
                  <div className="absolute -bottom-4 -right-4 w-28 h-28 border-2 border-[#D4AF37] shadow-xl overflow-hidden hidden sm:block bg-[#2A060B]">
                    <img
              ...
              <div className="mt-8 space-y-3">
                ...
                <p className="text-xs uppercase tracking-wider text-[#D4AF37]/80 font-mono">
                  Client: {hoveredIndexProject.client}
                </p>
                <p className="font-serif italic text-sm text-[#FFF0CA] pt-1">
                ...
                <div className="pt-4 flex items-center justify-between">
                  <button
                    ...
                    className="px-6 py-3 rounded-full bg-gradient-to-r from-[#D4AF37] via-[#F4E0A5] to-[#AA820A] text-[#2A060B] text-xs uppercase tracking-[0.2em] font-bold hover:shadow-xl hover:shadow-[#D4AF37]/30 transition-all cursor-pointer flex items-center gap-2"
                  >
