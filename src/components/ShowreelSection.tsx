    ...
    <section id="showreel" className="py-24 md:py-36 bg-[#2A060B] text-[#FDF9F0] relative border-t border-[#F8F1E7]/25 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-12 pb-8 border-b border-[#F8F1E7]/20">
          ...
          <div className="flex items-center gap-2 bg-[#1E0407]/90 p-1.5 rounded-full border-2 border-[#F8F1E7]/40 shadow-xl">
            <span className="text-xs uppercase tracking-[0.2em] text-[#F8F1E7] font-bold mr-2 ml-2 font-mono">Format:</span>
            <button
              ...
              className={`px-4 py-2 rounded-full text-xs uppercase tracking-[0.15em] flex items-center gap-1.5 transition-all cursor-pointer ${
                aspectMode === 'cinema'
                  ...
                  : 'border border-[#F8F1E7]/35 text-[#FDF9F0]/80 hover:border-[#F8F1E7] hover:text-white'
              }`}
            >
        ...
        <div className="relative max-w-5xl mx-auto">
          <div
            className={`relative mx-auto overflow-hidden bg-black shadow-2xl border-2 border-[#F8F1E7]/60 transition-all duration-700 rounded-xs ${
          ...
          >
            ...
            {!isPlaying && (
              ...
              >
                <div className="w-20 h-20 rounded-full bg-gradient-to-r from-[#F8F1E7] via-[#FCF9F5] to-[#E8DCCB] text-[#2A060B] flex items-center justify-center shadow-2xl transition-transform duration-300 group-hover:scale-110">
                  <Play className="w-8 h-8 ml-1 fill-current" />
                </div>
                <span className="mt-5 text-xs uppercase tracking-[0.3em] font-bold text-[#FDF9F0] font-mono">
                  Click to Experience Film
                </span>
                <span className="text-[11px] text-[#F8F1E7] tracking-wider mt-1 font-mono">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black/90 via-black/50 to-transparent flex items-center justify-between text-[#FDF9F0]">
              <div className="flex items-center gap-4">
                <button
                  onClick={togglePlay}
                  className="p-2 hover:text-[#F8F1E7] text-[#FDF9F0] transition-colors cursor-pointer"
                >
                ...
                <span className="text-[11px] tracking-[0.2em] uppercase font-mono text-[#F8F1E7] font-bold">
                  01:42 // 4K 24FPS
                </span>
              </div>

              <div className="flex items-center gap-3">
                <span className="text-[10px] tracking-[0.25em] uppercase text-[#F8F1E7]/90 font-mono hidden sm:inline">
          ...
          <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-6 text-[#FDF9F0]/85 text-xs">
            <div className="border-l-2 border-[#F8F1E7]/40 pl-5 bg-[#1E0407]/60 p-4 rounded-xs">
              <span className="text-[10px] uppercase tracking-[0.25em] text-[#F8F1E7] font-bold block mb-1 font-mono">Editing Discipline</span>
              <p className="font-light leading-relaxed">
                Precision cutdowns, dynamic speed ramps, analog grain textures, and frame-accurate audio synchrony.
              </p>
            </div>
            <div className="border-l-2 border-[#F8F1E7]/40 pl-5 bg-[#1E0407]/60 p-4 rounded-xs">
              <span className="text-[10px] uppercase tracking-[0.25em] text-[#F8F1E7] font-bold block mb-1 font-mono">Retention Strategy</span>
              <p className="font-light leading-relaxed">
                Designed to arrest attention within the initial 1.8 seconds across TikTok, Instagram, and premium web displays.
              </p>
            </div>
            <div className="border-l-2 border-[#F8F1E7]/40 pl-5 bg-[#1E0407]/60 p-4 rounded-xs flex flex-col justify-between">
              <div>
                <span className="text-[10px] uppercase tracking-[0.25em] text-[#F8F1E7] font-bold block mb-1 font-mono">Commission Reel</span>
                <p className="font-light">Ready to craft your next brand campaign or viral asset?</p>
              </div>
              <button
                onClick={onOpenInquiry}
                className="mt-3 text-left text-xs uppercase tracking-[0.2em] font-bold text-[#F8F1E7] hover:text-[#FCF9F5] underline underline-offset-4 transition-colors cursor-pointer"
              >
