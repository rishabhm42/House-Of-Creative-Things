...
export const ServicesPage: React.FC<ServicesPageProps> = ({
  ...
  const processSteps = [
    {
      ...
      desc: 'We begin by establishing the conceptual register: analyzing reference cinema, defining aspect ratios (1.33:1, 2.39:1, 9:16), curating typographic pairings, and scoring acoustic stems.',
    },
    {
      num: '02',
      title: 'Assembly & Rhythmic Pacing',
      desc: 'Footage is edited frame-by-frame with deliberate musical pacing. For graphic design, layouts undergo stringent architectural grid testing inspired by classical symmetry.',
    },
    {
      num: '03',
      title: 'Color Grading & Film Emulation',
      desc: 'Application of custom film emulation curves, sound effect layering (rich ambient acoustic resonance, tactile film noise), and foil stamping dieline checks for physical packages.',
    },
    {
      num: '04',
      title: 'Master Delivery & Multi-Ratio Archival',
      desc: 'Delivery of ProRes 4444 master files, social cutdowns optimized for compression algorithms, vector identity bibles, and print-ready CMYK collateral.',
    },
  ];
  ...
  return (
    <div className="pt-24 md:pt-32">
      ...
      <section className="py-20 px-6 md:px-12 border-b border-[#F8F1E7]/20 bg-[#230508]/70 relative">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-3 mb-3">
            <Sparkles className="w-4 h-4 text-[#F8F1E7]" />
          ...
          <h2 className="font-serif text-3xl sm:text-4xl text-[#FDF9F0] mb-12">
            How Every Studio Commission Unfolds
          </h2>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {processSteps.map((step) => (
              <div key={step.num} className="border-t-2 border-[#F8F1E7]/40 pt-6 space-y-3 bg-[#1E0407]/60 p-6 rounded-xs relative group hover:border-[#F8F1E7] transition-colors shadow-lg">
                <span className="text-xs font-mono text-[#F8F1E7] block font-bold">
                  Phase // {step.num}
                </span>
      ...
      <section className="py-24 px-6 md:px-12 border-t border-[#F8F1E7]/25 bg-[#230508]/85">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="p-8 border-2 border-[#F8F1E7]/30 bg-[#1E0407]/80 space-y-4 rounded-xs shadow-xl">
            <Clock className="w-6 h-6 text-[#F8F1E7]" />
          ...
          <div className="p-8 border-2 border-[#F8F1E7]/30 bg-[#1E0407]/80 space-y-4 rounded-xs shadow-xl">
            <Sliders className="w-6 h-6 text-[#F8F1E7]" />
          ...
          <div className="p-8 border-2 border-[#F8F1E7]/30 bg-[#1E0407]/80 space-y-4 rounded-xs shadow-xl">
            <Sparkles className="w-6 h-6 text-[#F8F1E7]" />
